...
-- Dumping data for table supermercado.fornecedores: ~5 rows (approximately)
...
INSERT INTO `produtos` (`id_produto`, `nome`, `preco`, `perco_desconto`) VALUES
	(1, 'Batatas', 0.50, 0.35),
	(2, 'Arroz', 0.75, 0.53),
	(3, 'couves', 0.55, 0.39),
	(4, 'Espargos', 1.75, 1.23),
	(5, 'Ervilhas', 2.55, 1.79);
/*!40000 ALTER TABLE `produtos` ENABLE KEYS */;

-- Dumping structure for table supermercado.prod_obsoletos
CREATE TABLE IF NOT EXISTS `prod_obsoletos` (
  `id_obsoletos` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) NOT NULL,
  `preco` decimal(10,2) NOT NULL,
  `preco_desconto` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id_obsoletos`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table supermercado.prod_obsoletos: ~5 rows (approximately)
/*!40000 ALTER TABLE `prod_obsoletos` DISABLE KEYS */;
INSERT INTO `prod_obsoletos` (`id_obsoletos`, `nome`, `preco`, `preco_desconto`) VALUES
	(6, 'Feijão', 1.50, 1.00),
	(7, 'Maça', 0.95, 0.85),
	(8, 'Perâ', 0.25, 0.15),
	(9, 'Kiwi', 1.95, 1.50),
	(10, 'Lentilhas', 0.45, 0.35);
/*!40000 ALTER TABLE `prod_obsoletos` ENABLE KEYS */;
